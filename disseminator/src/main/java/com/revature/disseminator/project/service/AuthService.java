...
import com.revature.disseminator.project.model.VerificationToken;
import com.revature.disseminator.project.repository.UserRepository;
import com.revature.disseminator.project.repository.VerificationTokenRepository;
import com.revature.disseminator.project.security.JwtProvider;
...
public class AuthService {
    ...
    public void signup(RegisterRequest registerRequest) {
        ...
        mailService.sendMail(new NotificationEmail("Please Activate your Account",
                user.getEmail(), "Thank you for signing up to Disseminator, " +
                "please click on the below url to activate your account : " +
                "http://localhost:8080/api/auth/accountVerification/" + token));
        LOGGER.info("Activated your account");
    }
